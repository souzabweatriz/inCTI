      ...
      <section class="login-card">
        ...
        <div class="flex items-center gap-2 mb-6">
          <img
            ...
            alt="InCTI"
            class="w-[1.75rem] h-[1.75rem] object-contain"
          >
        ...
        <form class="flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input
              ...
              class="w-full h-[2.5rem] px-3 rounded-md bg-white/[0.04] border border-white/[0.1] text-white text-[0.7rem] placeholder:text-white/20 outline-none focus:border-[#bbdec6] transition"
            >
          </div>
