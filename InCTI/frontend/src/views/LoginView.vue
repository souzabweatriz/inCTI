...
<template>
    <main class="login-page flex min-h-screen w-full relative overflow-hidden">
        ...
        >
            ...
            <div
                class="flex w-full max-w-[72rem] items-center justify-center gap-8 md:gap-12 lg:gap-20 xl:gap-28"
            >

                <section
                    class="hidden md:flex w-[18rem] lg:w-[24rem] xl:w-[27rem] shrink-0 flex-col justify-center"
                >

                    <p
                        class="text-[#bbdec6] text-[0.55rem] sm:text-[0.6rem] uppercase tracking-[0.3em] font-medium"
                    >
                    ...
                    <p
                        class="text-white/35 text-[0.7rem] lg:text-[0.75rem] leading-relaxed mt-5 max-w-[22rem]"
                    >
                    ...
                    <div class="login-card-content">
                        ...
                        <div class="flex items-center justify-center gap-2 mb-8">
                            ...
                            <img
                                ...
                                alt="InCTI"
                                class="flex w-8 h-8 object-contain"
                            >

                            <span
                                class="text-white text-[0.95rem] font-semibold tracking-[0.08em]"
                            >
                                InCTI
                            </span>
                        ...
                        <div class="flex flex-col items-center text-center mb-8">
                            ...
                            <h2
                                class="text-white text-[1.45rem] font-semibold tracking-[0.01em]"
                            >
                                Bem-vindo de volta
                            </h2>

                            <p
                                class="text-white/45 text-[0.7rem] mt-3 leading-relaxed max-w-[19rem]"
                            >
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <label
                                    for="usuario"
                                    class="text-white/60 text-[0.6rem] uppercase tracking-[0.16em]"
                                >
                                    Usuário
                                </label>
                            ...
                            >
                                ...
                                <label
                                    class="flex items-center gap-2 text-white/45 text-[0.6rem] cursor-pointer"
                                >

                                    <input
                                        type="checkbox"
                                        class="flex w-3 h-3 accent-[#bbdec6]"
                                    >
                            ...
                            <p
                                v-if="mensagem"
                                class="flex justify-center text-[#ff8f8f] text-[0.65rem] text-center"
                            >
                                {{ mensagem }}
                            </p>
                        ...
                        <div class="flex items-center gap-4 my-7">
                            ...
                            <span
                                class="text-white/25 text-[0.55rem] whitespace-nowrap tracking-[0.04em]"
                            >
                                ou continue com
                            </span>
                        ...
                        >
                            ...
                            <router-link
                                to="/"
                                class="text-[#bbdec6] ml-1 hover:underline"
                            >
                                Saiba mais
                            </router-link>
